...
public class Pager {
	...
	private boolean pageFlag = true;//是否启动分页
	...
	public String getOrderCondition() {
		...
		if (this.orderField != null && this.orderField.length() != 0) {
			...
			condition = " order by " + orderFieldStr + (orderDirection ? " " : " desc ");
		}
		return condition;
	}
	...
	public String getPostgreSqlQueryCondition() {
		String condition = "";
		if (pageFlag) {
			condition = " limit " + pageSize + "offset " + pageOffset;
		}
		return condition;
	}
